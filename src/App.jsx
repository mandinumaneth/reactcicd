  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-indigo-900 to-black text-white font-sans">
      <div className="max-w-2xl mx-auto py-16 px-6">
        <header className="mb-10 text-center">
          <h1 className="text-5xl font-extrabold text-indigo-400 drop-shadow-lg mb-4">
    ...
    `}
            ...
            <p className="text-gray-200">
              ...
              <span className="font-semibold text-indigo-200">main</span>.
            </p>
          </section>
          <section className="mb-8">
            <h2 className="text-3xl font-bold text-indigo-300 mb-2">
            ...
            <ol className="list-decimal pl-6 text-gray-200">
              ...
              <li>
                Find{" "}
                <span className="font-semibold text-indigo-200">Pages</span>{" "}
                section
              </li>
              <li>
                Set the source to{" "}
                <span className="font-semibold text-indigo-200">gh-pages</span>{" "}
                branch
              </li>
